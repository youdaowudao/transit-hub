...
var workspaceDeleteStatements = []workspaceDeleteStatement{
	...
	{Name: "connection_health_priority_workspace_sync_states", SQL: `DELETE FROM connection_health_priority_workspace_sync_states WHERE user_id = $1 AND admin_account_id = $2`},
...
var legacyWorkspaceTables = []workspaceTableDescriptor{
	...
	{Name: "connection_health_priority_workspace_sync_states", WorkspaceColumn: "admin_account_id"},
