export default {
  ...
  admin: {
    ...
    dashboard: {
      ...
      costQuality: {
        complete: 'Cost {cost}',
        partial: 'Confirmed cost {cost}, {collected}/{expected} sites',
        netProfitCeiling: 'Upper estimate {value}',
        marginCeiling: 'Upper estimate {value}%',
        profitUnavailable: 'Revenue unavailable',
        costUnavailable: 'Cost unavailable',
        deltaPartial: 'Cost incomplete, comparison unavailable',
        deltaUnsettled: 'Yesterday not settled'
      },
      dailyStats: {
        title: 'Daily Details',
        from: 'From',
        ...
        shortcutDayBefore: '2 Days Ago',
        shortcut3DaysAgo: '3 Days Ago',
        ...
        statusMissing: 'Unsettled',
        colDate: 'Date',
        colRevenue: 'Revenue',
        colCost: 'Confirmed Cost',
        colNetProfit: 'Net Profit / Est.',
        colCoverage: 'Coverage',
        colStatus: 'Status',
        expandSites: 'Expand Sites',
        collapseSites: 'Collapse',
        noData: 'No data in this date range',
        loadError: 'Failed to load daily stats'
      },
      dataStatus: {
