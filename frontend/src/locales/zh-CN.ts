  ...
  admin: {
    ...
    connectionHealth: {
      ...
      manualProbeDialog: {
        ...
        questionAnswer: {
          ...
          repeatCount: '每组合执行次数',
          repeatCountInvalid: '每组合执行次数必须是 1–10 的整数。',
          selectionRequired: '请至少选择一个模型和一个测试问题。',
          activeStartBlocked: '当前批次仍在运行，完成或终止后才能开始下一批。',
          noQuestions: '当前没有启用的测试问题，请前往设置页添加或启用。',
          defaultQuestion: '默认',
          selectedFormula: '模型 {models} 个 × 问题 {questions} 个 × 每组合 {repeat} 次 = 共 {total} 次请求',
          batchLimit: '本次共 {total} 次请求，单批最多 50 次，请减少模型、问题或次数。',
          start: '开始问答测试',
          startAnswer: '开始回答',
          leave: '离开',
          submitting: '正在提交...',
          pendingReviewTitle: '当前待审回答',
          waitingForReviewableAnswer: '问答仍在运行，正在等待可复审回答。',
          noPendingReview: '当前批次没有待审回答。',
          processedSummary: '本批次已处理 {total} 条 · 正确 {correct} · 错误 {incorrect}',
          noProcessedAnswers: '本批次还没有已处理回答。',
          failedSummary: '失败 {count} 条',
          newTestConfiguration: '新测试配置',
          modifyConfiguration: '修改',
          collapseConfiguration: '收起配置',
          configurationSummary: '问题 {questions} 个 · 推理力度 {effort} · 每组合 {repeat} 次',
          rememberedConfiguration: '已记住（本浏览器，当前管理员的 OpenAI 分组共用）',
          activeConfiguration: '当前进行中批次使用此配置；完成后仍保留已记住的下次配置。',
          todayHistoryTitle: '今日历史',
          currentTitle: '当前批次',
          reviewTitle: '复审批次',
          reviewThisBatch: '复审此批次',
          reviewLatestBatch: '回到最新批次',
          reviewBatchId: '批次 {id}',
          batchCompletedAt: '完成于 {time}',
          batchStillRunning: '仍在运行',
          batchTimeUnknown: '完成时间未知',
          latestBatchStillRunning: '最新批次仍在后台运行，不影响当前复审。',
          ...
          incorrect: '错误',
          saving: '保存中',
          noKeywordSnapshot: '无关键字快照',
          judgmentRefreshFailed: '判定已保存，统计刷新失败。',
      ...
      errors: {
        ...
        testQuestionKeywordBlank: '关键字不能是空白内容。',
        testQuestionKeywordCount: '关键字最多 20 个。',
        testQuestionKeywordLength: '每个关键字最多 64 个字符。',
        testQuestionKeywordBytes: '关键字总计最多 2048 个 UTF-8 字节。',
        ...
        questionAnswerRepeatCount: '每组合执行次数必须是 1–10 的整数。',
        questionAnswerBatchLimit: '单批问答最多允许 50 次请求，请减少模型、问题或次数。',
    ...
    settings: {
      ...
      testQuestions: {
        ...
        keywords: '关键字',
        keywordsPlaceholder: '使用半角逗号或换行分隔关键字',
        keywordsHint: '最多 20 个；每个最多 64 个字符；总计最多 2048 个 UTF-8 字节。',
        noKeywords: '未配置关键字',
        add: '新增问题',
        saveEdit: '保存修改',
        cancelEdit: '取消编辑',
